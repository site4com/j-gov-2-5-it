		...
		<tr class="<?php echo "row$k"; ?>">
            ...
            <td>
                <?php
                    ...
                    if($row->id == $this->ak_record){
                        ?>Alt + Shift + <input type="hidden" id="cid_<?php echo $this->ak_record ?>"  name="cid[]" value="<?php echo $this->ak_record ?>"/><input type="text" style="width:40px;height:25px;" size="1" name="accesskey" value="<?php echo $row->accesskey ?>" />&nbsp;<button type="submit" class="ak_ok" onclick="$('task').value='accesskey.save';"><?php echo JText::_( 'Save' )?></button>&nbsp;<button type="submit" onclick="$('task').value='';"  class="ak_ko"><?php echo JText::_( 'Cancel' )?></button>
                        <?php
                    }
                    else
                    {
                        ...
                        ?>
                        &nbsp;Alt + Shift + <strong style="color:red"><?php echo $row->accesskey; ?></strong><?php
                    }
                ?>
            </td>
		</tr>
