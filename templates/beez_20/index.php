...
if ($_REQUEST['option'] == 'com_content'
    ...
    if (strpos( $_SERVER['REQUEST_URI'],'featured') === false){
       $doc->setTitle($pageTitle); 
        ...
        $doc->setTitle(htmlspecialchars($doc->getTitle(), ENT_COMPAT, 'UTF-8')); 
   }
        ...
        <div id="back">
                ...
                <div id="header">
                                ...
                                <div class="logoheader">
                                        ...
                                        <img src="<?php echo $this->baseurl ?>/<?php echo htmlspecialchars($logo); ?>"  alt="<?php echo htmlspecialchars($templateparams->get('sitetitle'));?>" width="225" height="50" />
